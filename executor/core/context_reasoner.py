...
---------------------------------
Phase 2.12c — Context Reasoner + cosmetic deduplication & grammar fixes
"""
...
def _deduplicate_and_pretty(items: List[str]) -> str:
    """
    Remove near-duplicate items (case-insensitive, trimmed) and
    return a grammatically clean string like "A, B, and C".
    """
...
# Core reasoning
# ---------------------------------------------------------------------
def reason_about_context(query: str) -> Dict[str, Any]:
    """
