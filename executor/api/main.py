...
async def chat(body: ChatBody, request: Request) -> Dict[str, Any]:
    ...
    # --- Step 1: semantic interpretation (facts + corrections) ---
    intent = detect_fact_or_question(text)
    intent_type = intent.get("type")
    key, val = intent.get("key"), intent.get("value")
