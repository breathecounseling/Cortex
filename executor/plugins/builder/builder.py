...
def main(plugin_name: str, description: str):
    ...
    # Render specialist.py from template
    env = Environment(loader=FileSystemLoader(str(TEMPLATE_DIR)))
    template = env.get_template("specialist_fallback.py.j2")
    specialist_code = template.render(plugin_name=plugin_name, description=description)
