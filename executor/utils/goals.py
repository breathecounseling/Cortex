...
-----------------------
Phase 2.20.5 — Temporal Goals + Deadlines + Priority/Effort
Fixes:
 - Added due_within_days() with proper "today" filtering
 - Added imports for List, Dict, Optional
 - Maintains schema migration safety and all CRUD utilities
"""
...
def due_soon_goals(session_id: str, within_days: int=3) -> List[Dict]:
    return due_within_days(session_id, within_days=within_days)
